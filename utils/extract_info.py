"""Передаем в главную функцию .soup страницу. Скрипт достанет всю информацию из одного конкретного объявления и вернет в виде словаря
...
if __name__ == "__main__":
    ...
    #url с объявлением
    URL = "https://www.bezrealitky.cz/nemovitosti-byty-domy/877897-nabidka-pronajem-bytu-u-dekanky-praha"
    ...
    try:
        ...
        print(json.dumps(get_property_info(soup), ensure_ascii=False, indent=2))
